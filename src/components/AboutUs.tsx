...
const AboutUs = () => {
    return (
        <div className="flex flex-row justify-between space-x-7 px-14 py-16 bg-[#c2d2d6]">
            <div>
                <img className="h-52 w-96 mb-7  rounded-md" src={require('../images/analise.jpg')} alt='' />
            ...
            <div>
                <img className="h-52 w-96 mb-7  rounded-md" src={require('../images/structure.jpg')} alt='' />
            ...
            <div>
                <img className="h-52 w-96 mb-7  rounded-md" src={require('../images/creation.jpg')} alt='' />
